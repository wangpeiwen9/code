...
from onekey_core.core.losses3D.basic import expand_as_one_hot
from onekey_core.core.losses3D.dice import DiceLoss
...
class BCEDiceLoss(nn.Module):
    ...
    def __init__(self, alpha=1, beta=1, classes=4, weight=None):
