...
from onekey_core.models.res2net_v1b import res2net50_v1b_26w_4s
...
class PraNet(nn.Module):
    ...
    def forward(self, x):
        ...
        lateral_map_5 = F.interpolate(ra5_feat, scale_factor=8, mode='bilinear',
                                      align_corners=True)  # NOTES: Sup-1 (bs, 1, 44, 44) -> (bs, 1, 352, 352)
        ...
        lateral_map_4 = F.interpolate(x, scale_factor=32, mode='bilinear',
                                      align_corners=True)  # NOTES: Sup-2 (bs, 1, 11, 11) -> (bs, 1, 352, 352)
        ...
        lateral_map_3 = F.interpolate(x, scale_factor=16, mode='bilinear',
                                      align_corners=True)  # NOTES: Sup-3 (bs, 1, 22, 22) -> (bs, 1, 352, 352)
        ...
        lateral_map_2 = F.interpolate(x, scale_factor=8, mode='bilinear',
                                      align_corners=True)  # NOTES: Sup-4 (bs, 1, 44, 44) -> (bs, 1, 352, 352)
