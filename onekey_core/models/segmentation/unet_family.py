...
__all__ = ['UNet', 'R2UNet', 'R2AttUNet', 'NestedUNet', 'AttUNet']
...
class UNet(nn.Module):
    ...
    def __init__(self, in_ch=3, num_classes=2, **kwargs):
...
class R2UNet(nn.Module):
    ...
    def __init__(self, img_ch=3, num_classes=2, t=2, **kwargs):
...
class AttUNet(nn.Module):
    ...
    def __init__(self, img_ch=3, num_classes=2, **kwargs):
...
class R2AttUNet(nn.Module):
    ...
    def __init__(self, in_ch=3, num_classes=2, t=2, **kwargs):
...
class NestedUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        output = self.active(self.final(x0_4))
        return output
