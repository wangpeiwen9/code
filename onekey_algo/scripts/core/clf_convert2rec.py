...
from onekey_algo.utils import truncate_dir, split_dataset, create_dir_if_not_exists
...
def clf_covert2rec(input_dir: str, save_dir: str, partition: List[float] = [0.8, 0.2], cmd=False):
    ...
    if cmd:
        ...
        commands = [r'cd C:\Users\onekey\.conda\envs\onekey\Lib\site-packages\onekey_algo/classification',
