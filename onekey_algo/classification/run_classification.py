        ...
        for phase in ['train', 'valid']:
            ...
            if phase == 'train':
                ...
                if epoch_metric > best_acc:
                    ...
                    # Spec文件
                    shutil.copyfile(os.path.join(train_dir, f'Epoch-{epoch}_spec.csv'),
                                    os.path.join(viz_dir, f'BST_TRAIN_RESULTS_SPEC.csv'))
                    shutil.copyfile(os.path.join(valid_dir, f'Epoch-{epoch}_spec.csv'),
                                    os.path.join(viz_dir, f'BST_VAL_RESULTS_SPEC.csv'))
...
def main(args):
    ...
    try:
        if 'vit' in args.model_name.lower():
            vit_settings = args.vit_settings
            kwargs.update(args.vit_settings)
    except:
        pass
