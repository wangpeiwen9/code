...
from onekey_core.models.fusion.dnn_model import CostumeNet
from onekey_algo.structure_dnn.structured_ds import StructuredDataset
from onekey_algo.structure_dnn.custom_utils import metric_func_clf, metric_func_reg
from onekey_core.core import create_optimizer, create_lr_scheduler, create_losses
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Onekey Structure Model')
