...
EVAL_METRIC_NAMES = ['AP', 'APIoU=.50', 'APIoU=.75', 'APsmall', 'APmedium', 'APlarge',
                     'ARmax=1', 'ARmax=10', 'ARmax=100', 'ARsmall', 'ARmedium', 'ARlarge']
...
class CocoEvaluator(object):
    ...
    def summarize(self):
        ...
        for iou_type, coco_eval in self.coco_eval.items():
            ...
            coco_eval.summarize()
            eval_str[iou_type] = str(coco_eval.stats)
        return eval_str
